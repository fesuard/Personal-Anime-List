...
def home_view(request):
    ...
    fact_list = [
        ...
        (
            'Hayao Miyazaki is one of the most renowned anime directors, known for films like "Spirited Away" and "My'
            ' Neighbor Totoro."'
        ),
        ...
        (
            '"One Piece" holds the Guinness World Record for the most copies published for the same comic book series'
            " by a single author."
        ),
        (
            '"Pokémon" is a globally recognized anime franchise, known for its video games, trading cards, and animated'
            " series."
        ),
        (
            '"Attack on Titan" is a dark fantasy anime series that has gained widespread acclaim for its intense action'
            " and compelling story."
        ),
        "Studio Ghibli is a renowned Japanese animation studio responsible for many beloved anime films.",
        (
            '"Death Note" is a psychological thriller anime series about a high school student who gains the power to'
            " kill anyone by writing their name in a notebook."
        ),
        (
            '"Fullmetal Alchemist" is a popular anime series known for its complex storyline and well-developed'
            " characters."
        ),
        '"Sailor Moon" is a classic magical girl anime series that has inspired generations of fans.',
        (
            '"Cowboy Bebop" is a critically acclaimed anime series that blends elements of science fiction, noir, and'
            " jazz music."
        ),
        (
            '"Neon Genesis Evangelion" is a groundbreaking mecha anime series known for its psychological themes and'
            " complex narrative."
        ),
    ]
    ...
    if request.user.is_authenticated:
        ...
        context = {"random_anime": random_anime, "random_fact": random_fact, "no_soft_stats": [no_message, no_stats]}
        return render(request, "animeList/homepage.html", context)
